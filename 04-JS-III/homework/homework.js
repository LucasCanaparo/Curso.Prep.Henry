...
function arrayContiene(array, elemento) {
  ...
  //.includes() sirve para saber si un elemento existe dentro de un array
...
function numeroMasGrande(numeros) {
  ...
  //".max.apply()" sirve para encontrar el elemento mayor en un array numérico
...
function cuentoElementos(arreglo){
  ...
  {
    // arreglo[i] > 18 ? contador++ : null; es otra forma de "if"
    if(arreglo[i] > 18)
    {
      contador++;
    }
...
function diaDeLaSemana(numeroDeDia) {
  ...
  //el switch solamente compara igualdad (o desigualdad "!")
  switch(numeroDeDia)
  {
    case 1:
